        ...
        <div className="footer-grid">
          <div className="footer-brand">
            ...
            <div className="footer-social">
              <a href="https://www.instagram.com/andreamariacoaching/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="footer-social-link">
              ...
              <a href="https://wa.me/491727570083" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp" className="footer-social-link">
                <svg viewBox="0 0 24 24" fill="currentColor" width="20" height="20">
          ...
          <div className="footer-links">
            <h4>Kontakt</h4>
            <ul>
              <li><a href="mailto:kontakt@andreamariacoaching.de">kontakt@andreamariacoaching.de</a></li>
